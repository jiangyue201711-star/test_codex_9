#lang racket
      ...
      ;; task_id=0010, difficulty=L2, types=[B J]
      ;; dynamic_features={"arith": false, "vars": true, "lambda": false, "recursion": false, "higher_order": true, "condition": false, "multi_layer": false, "self_host": false, "symbolic_list": true, "local_scope": false, "lazy_eval": false}
