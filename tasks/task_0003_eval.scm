#lang racket
    ...
    ;; task_id=0003, difficulty=L3, types=[C N]
    ;; dynamic_features={"arith": false, "vars": false, "lambda": true, "recursion": false, "higher_order": true, "condition": false, "multi_layer": false, "self_host": false, "symbolic_list": false, "local_scope": false, "lazy_eval": false, "io_basic": false, "meta_program": true}
