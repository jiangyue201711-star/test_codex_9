#lang racket
 ...
 ;; task_id=0008, difficulty=L8, types=[A E N]
 ;; variants={"arith": "modulo"}
 ;; dynamic_features={"symbolic_list": false, "lazy_eval": false, "io_basic": false, "meta_program": true, "self_host_focus": false, "arith_modulo": true}
