#lang racket
        ...
        ;; task_id=0008, difficulty=L8, types=[H K L]
        ;; dynamic_features={"arith": false, "vars": true, "lambda": true, "recursion": true, "higher_order": false, "condition": true, "multi_layer": true, "self_host": true, "symbolic_list": false, "local_scope": true, "lazy_eval": true}
