#lang racket
 ...
 ;; task_id=0008, difficulty=L8, types=[A N O]
 ;; variants={"arith": "bitwise"}
 ;; dynamic_features={"symbolic_list": false, "lazy_eval": false, "io_basic": false, "meta_program": true, "loop_syntax": true, "vector_ds": false, "record_ds": false, "file_ops": false, "arith_variant": "bitwise"}
 ...
 (define primitive-env
   (list
    (cons 'bit-and bitwise-and)
(cons 'bit-or bitwise-ior)
(cons 'bit-xor bitwise-xor)
(cons 'shl (lambda (a b) (arithmetic-shift a b)))
(cons 'shr (lambda (a b) (arithmetic-shift a (- b))))
(cons '= =)
(cons '< <)
(cons '> >)
(cons '<= <=)
