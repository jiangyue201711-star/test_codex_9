#lang racket
        ...
        ;; task_id=0005, difficulty=L5, types=[G K]
        ;; dynamic_features={"arith": false, "vars": true, "lambda": true, "recursion": true, "higher_order": false, "condition": true, "multi_layer": true, "self_host": false, "symbolic_list": false, "local_scope": true, "lazy_eval": false}
