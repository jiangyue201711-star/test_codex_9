#lang racket
 ...
 ;; task_id=0005, difficulty=L5, types=[G P]
 ;; variants={"arith": "basic"}
 ;; dynamic_features={"symbolic_list": false, "lazy_eval": false, "io_basic": false, "meta_program": false, "loop_syntax": false, "vector_ds": true, "record_ds": false, "file_ops": false, "arith_variant": "basic"}
