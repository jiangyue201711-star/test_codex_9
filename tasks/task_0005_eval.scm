#lang racket
    ...
    ;; task_id=0005, difficulty=L5, types=[G M]
    ;; dynamic_features={"arith": false, "vars": false, "lambda": false, "recursion": false, "higher_order": false, "condition": false, "multi_layer": true, "self_host": false, "symbolic_list": false, "local_scope": false, "lazy_eval": false, "io_basic": true, "meta_program": false}
