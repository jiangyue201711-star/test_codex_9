#lang racket
        ...
        ;; task_id=0005, difficulty=L5, types=[G I]
        ;; dynamic_features={"arith": true, "vars": true, "lambda": true, "recursion": false, "higher_order": true, "condition": true, "multi_layer": true, "self_host": false}
