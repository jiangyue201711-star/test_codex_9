#lang racket
    ...
    ;; task_id=0001, difficulty=L1, types=[B M]
    ;; dynamic_features={"arith": false, "vars": true, "lambda": false, "recursion": false, "higher_order": false, "condition": false, "multi_layer": false, "self_host": false, "symbolic_list": false, "local_scope": false, "lazy_eval": false, "io_basic": true, "meta_program": false}
