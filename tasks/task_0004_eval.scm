#lang racket
 ...
 ;; task_id=0004, difficulty=L4, types=[D O]
 ;; variants={"arith": "basic"}
 ;; dynamic_features={"symbolic_list": false, "lazy_eval": false, "io_basic": false, "meta_program": false, "loop_syntax": true, "vector_ds": false, "record_ds": false, "file_ops": false, "arith_variant": "basic"}
