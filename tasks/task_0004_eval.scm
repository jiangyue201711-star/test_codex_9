#lang racket
    ...
    ;; task_id=0004, difficulty=L4, types=[F K]
    ;; dynamic_features={"arith": false, "vars": true, "lambda": true, "recursion": true, "higher_order": false, "condition": true, "multi_layer": false, "self_host": false, "symbolic_list": false, "local_scope": true, "lazy_eval": false, "io_basic": false, "meta_program": false}
