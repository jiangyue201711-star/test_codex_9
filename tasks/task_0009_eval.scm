#lang racket
 ...
 ;; task_id=0009, difficulty=L1, types=[A M]
 ;; variants={"arith": "comparison"}
 ;; dynamic_features={"symbolic_list": false, "lazy_eval": false, "io_basic": true, "meta_program": false, "loop_syntax": false, "vector_ds": false, "record_ds": false, "file_ops": false, "arith_variant": "comparison"}
