#lang racket
        ...
        ;; task_id=0006, difficulty=L6, types=[G L]
        ;; dynamic_features={"arith": false, "vars": false, "lambda": true, "recursion": false, "higher_order": false, "condition": false, "multi_layer": true, "self_host": false, "symbolic_list": false, "local_scope": false, "lazy_eval": true}
