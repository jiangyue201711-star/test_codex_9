#lang racket
 ...
 ;; task_id=0007, difficulty=L7, types=[I K N]
 ;; variants={"arith": "modulo"}
 ;; dynamic_features={"symbolic_list": false, "lazy_eval": false, "io_basic": false, "meta_program": true, "loop_syntax": false, "vector_ds": false, "record_ds": false, "file_ops": false, "arith_variant": "modulo"}
