#lang racket
        ...
        ;; task_id=0007, difficulty=L7, types=[H I L]
        ;; dynamic_features={"arith": true, "vars": true, "lambda": true, "recursion": false, "higher_order": true, "condition": true, "multi_layer": true, "self_host": true, "symbolic_list": false, "local_scope": false, "lazy_eval": true}
